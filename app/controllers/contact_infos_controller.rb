class ContactInfosController < ApplicationController
  ...
  private
    ...
    def contact_info_params
      params.require(:contact_info).permit(:first_name, :last_name, :maiden_name, :address_line1, :address_line2, :city, :state_id, :zip, :phone_number, :email, :show_email, :class_year, :instrument_id, :is_mv, :is_deleted, :is_primary)
    end
end
