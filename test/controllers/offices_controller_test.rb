...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { display_order: @office.display_order, email: @office.email, number_of_terms: @office.number_of_terms, term_length: @office.term_length, title: @office.title }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { display_order: @office.display_order, email: @office.email, number_of_terms: @office.number_of_terms, term_length: @office.term_length, title: @office.title }
    assert_redirected_to office_path(assigns(:office))
  end
